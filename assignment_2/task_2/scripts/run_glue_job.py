"""
Inicia o Glue job incremental e faz polling até o estado terminal.
Imprime o Job Run ID (útil como evidência — brief 3.4.3).

Lê credenciais AWS do .env e o nome do job de pipeline_info.json.
...
if state == "SUCCEEDED":
    print(f"\nJob finalizado com SUCCEEDED. Run ID: {run_id}")
    sys.exit(0)
else:
