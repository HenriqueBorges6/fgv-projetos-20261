...
resource "aws_security_group" "rds" {
  name        = "rds-classicmodels-a2t2-sg"
  description = "RDS MySQL (A2 Task 2) - acesso restrito ao IP do provisionador e ao Glue"
  ...
  tags = { Name = "rds-classicmodels-a2t2-sg" }
}

# Acesso da máquina local via /32 (sem 0.0.0.0/0)
...
# Acesso do Glue job ao RDS (extração JDBC + leitura/escrita do watermark)
